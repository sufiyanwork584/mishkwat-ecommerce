      ...
      >
        <div className="glass-card rounded-2xl p-8 relative overflow-hidden shadow-2xl">
          ...
          <div className="relative text-center mb-8">
            ...
            <p className="text-text-muted text-sm">Sign in to your Mishkwat account</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 relative" autoComplete="off">
            <Input
              label="Email Address"
              type="email"
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center text-text-muted cursor-pointer select-none">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-slate-700 bg-surface text-primary focus:ring-primary focus:ring-offset-0 mr-2"
                  {...register('rememberMe')}
                />
                Remember me
              </label>
              <Link
                to="/forgot-password"
                className="text-primary-light hover:text-text font-medium transition-colors"
              >
                Forgot password?
              </Link>
            </div>
